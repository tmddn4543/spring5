	    	...
	    	$("#grid").jqxGrid(//킵
                    {
                        ...
                        rendertoolbar: function (statusbar) {
                            ...
                            var addButton = $("<div style='float: right; margin-left: 10px;'><span style='margin-left: 4px; position: relative; top: -3px;'>파일 받기</span></div>");
                            var xlsButton = $("<div style='float: right; margin-left: 5px;'><span style='margin-left: -2px; position: relative; top: -3px;'>목록 받기</span></div>");
